package com.example.contactappandroid;
...
public final class Contract {
    ...
    public static final String CONTENT_AUTHORITY= "com.example.contactappandroid";
    public static final Uri BASE_URI=Uri.parse("content://"+CONTENT_AUTHORITY);
    public static final String PATH_CONTACTS="contactappandroid";

    public static abstract class ContactEntry implements BaseColumns{
        public static final Uri CONTENT_URI=Uri.withAppendedPath(BASE_URI,PATH_CONTACTS);

        public static final String TABLE_NAME="mescontacts";
        ...
        public static boolean isValidType (String type){
            if (type==TYPEOFCONTACT_HOME || type== TYPEOFCONTACT_WORK || type==TYPEOFCONTACT_PERSONAL){
                return true;
            }
            return false;
        }
